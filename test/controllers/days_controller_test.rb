...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference("Day.count") do
      post days_url, params: {day: {date: @day.date, description: @day.description, image: @day.image, is_locked: @day.is_locked}}
    end
  ...
  test "should update day" do
    patch day_url(@day), params: {day: {date: @day.date, description: @day.description, image: @day.image, is_locked: @day.is_locked}}
